...
然後結合 `ying-guides.md` 的十應判斷，輔助斷卦。
安裝與使用
作為 Claude Skill 安裝
...
| `bagua-wanwu.md` | 八卦類象+萬物賦 | 具體化推斷、歌訣參考 |
| `case-studies-expanded.md` | 學習解卦方法 | 參考經典案例 |
| `ying-guides.md` | 十應+外應指南 | 用戶提供環境信息 |
...
倫理指引詳細版 (Ethics Guidelines - Full Version)
